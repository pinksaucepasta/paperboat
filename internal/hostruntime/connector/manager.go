...
func New(config Config) (*Manager, error) {
	if config.Dialer == nil || config.EnvironmentID == "" || config.MachineID == "" || config.ConnectorID == "" || config.EdgePool == "" {
